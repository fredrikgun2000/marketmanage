@extends('main')
@section('pembelian')
<input type="hidden" name="" id="pagination" value="Pembelian">
...
<div class="container-fluid">
	<div class="row">
		...
		<form action="/PembelianPost" method="POST">
			@csrf
				<div class="row bgcolor2 mb-2">
					<div class="col-lg-6">
			 			<div class="row">
			 				<div class="col-lg-4">
		...
		<div class="row my-2">
			<div class="col-lg-6">
				...
				<div class="row my-2">
					...
					<div class="col-lg-5"><input type="number" min="0" value ="0" name="disc1t" id="disc3k" ></div>
				</div>
				<div class="row my-2">
					<div class="col-lg-7">Discount Nom</div>
					<div class="col-lg-5"><input type="number" min="0" value ="0" name="discnominalt" id="discnominal2"></div>
				</div>
				<div class="row my-2">
			...
			<div class="col-lg-6">
				<div class="row my-2">
					<div class="col-lg-7">Pembayaran </div>
				...
				<div id="PelunasanSelect">
				<div class="row my-2" id="pehutangan" style="display: none;">
					<div class="col-lg-7">Jatuh Tempo</div>
					<div class="col-lg-5"><input type="date" name="tempo" id="tempo"></div>
				</div>
				<div class="row my-2">
					<div class="col-lg-7">Tunai</div>
					<div class="col-lg-5"><input type="number" min="0" value="0" name="tunai" id="tunai"></div>
				</div>
				<div class="row my-2">
					<div class="col-lg-7">Debit</div>
					<div class="col-lg-5"><input type="number" min="0" value="0" name="debit" id="debit"></div>
				</div>
				<div class="row my-2">
					<div class="col-lg-7">E-Money</div>
					<div class="col-lg-5"><input type="number" min="0" value="0" name="money" id="money"></div>
				</div>
				<div class="row my-2">
